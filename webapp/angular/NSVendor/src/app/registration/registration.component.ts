...
import { ValidateContactNotTaken } from '../validator/contact.validator';
...
export class RegistrationComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.loading = true;
    this.authenticationService.verifyRegistration(this.registerForm.value)
      .pipe(first())
      .subscribe(
        data => {
          this.router.navigate(['/otp'], { queryParams: { registered: false } });
        },
        error => {
          Swal.fire({
            icon: 'error',
